  ...
  <div class="container-fluid" style="background-color: black;">
    <div class="container"  style="width: 100%;">
      <div class="main-content d-flex " >
        ...
        @endif
          <form method="post" action="{{route('New_UnsubotpVerfication')}}">
            @csrf
            <div class="row d-flex  mt-2 ml-3" id="otp_mainContainer">
              <div class="OTP_div ml-3">
              <input class="phone-InputField" id="Otp-InputField" type="text" name="digit1" placeholder="X" maxlength="1" required>
              </div>
              <div class="OTP_div ml-2" >
              <input class="phone-InputField" id="Otp-InputField" type="text" name="digit2" placeholder="X" maxlength="1" required>
              </div>
              <div class="OTP_div ml-2">
              <input class="phone-InputField" id="Otp-InputField" type="text" name="digit3" placeholder="X" maxlength="1" required>
              </div>
              <div class="OTP_div ml-2">
              <input class="phone-InputField" id="Otp-InputField" type="text" name="digit4" placeholder="X" maxlength="1" required>
              </div>
            </div>
            <div class="row mt-1" >
